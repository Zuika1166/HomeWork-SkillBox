...
#8
a = int(input('Введите на сколько градусов градусов повернулась часовая стрелка: '))
print((a % 30) * 12)

# 9
# Мы еще не проходили квадратное уравнение, по этому н емогу решить данную задачу

#10
#1
# Знаю что нельзя использовать max() и if, но подругому не знаю как
one = int(input('Введите первое число: '))
two = int(input('Введите первое число: '))
print('Наибольшее число', max(one, two))
...
if two > max_all:
    max_all = two
print('Наибольшее число', max_all)